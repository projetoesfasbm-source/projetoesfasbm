...
DADOS_QUESTIONARIO = {
    ...
    "perguntas": [
        ...
        {"texto": "De onde você é? (Cidade/Região)", "tipo": "unica", "opcoes": [
            "Porto Alegre e Região Metropolitana",
            "Caxias do Sul e Região da Serra",
            "Pelotas e Região Sul",
            "Santa Maria e Região Central",
            "Passo Fundo e Região Norte",
        ...
        {"texto": "Trabalha em qual Comando Regional (CRPO)?", "tipo": "unica", "opcoes": [
            "CRPO Metropolitano",
            "CRPO Litoral",
            "CRPO Central",
            ...
            "Comando Ambiental (CABM)",
            "Comando Rodoviário (CRBM)",
            "Outro Batalhão/Comando"
        ]},
        {"texto": "Onde está lotado?", "tipo": "unica", "opcoes": ["Pelotão", "Companhia", "Seção Administrativa", "Outro"]},
