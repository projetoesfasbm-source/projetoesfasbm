...
def upgrade():
    ...
    with op.batch_alter_table('configuracoes_envio', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('uq_escola_materia_envio'))
    ...
    with op.batch_alter_table('fada_avaliacoes', schema=None) as batch_op:
        ...
        batch_op.alter_column('aat_snapshot',
               ...
               nullable=False,
               existing_server_default=sa.text("'0'"))
        batch_op.drop_constraint(batch_op.f('fada_avaliacoes_ibfk_2'), type_='foreignkey')
    ...
    with op.batch_alter_table('processos_disciplina', schema=None) as batch_op:
        ...
        batch_op.alter_column('ciente_aluno',
               ...
               nullable=False,
               existing_server_default=sa.text("'0'"))
        batch_op.drop_index(batch_op.f('idx_processo_codigo'))
        batch_op.drop_index(batch_op.f('idx_processo_status_data'))
